...
namespace Academy.Server.Utilities
{
    ...
    public static class TraceLogHandlerExtensions
    {
        ...
        {
            return builder.AddHttpMessageHandler((services) => new TraceLogHandler(services, shouldLog));
        }

        public static IHttpClientBuilder AddTraceLogHandler(this IHttpClientBuilder builder)
        {
            return builder.AddHttpMessageHandler((services) => new TraceLogHandler(services, (HttpResponseMessage) => { return false; }));
        }
    }
}