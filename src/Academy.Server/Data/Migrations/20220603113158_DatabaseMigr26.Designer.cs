...
namespace Academy.Server.Data.Migrations
{
    ...
    [Migration("20220603113158_DatabaseMigr26")]
    partial class DatabaseMigr26
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Academy.Server.Data.Entities.PostReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Academy.Server.Data.Entities.Course", b =>
                {
                    b.HasOne("Academy.Server.Data.Entities.User", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("Academy.Server.Data.Entities.PostReaction", b =>
                {
                    b.HasOne("Academy.Server.Data.Entities.Post", "Post")
                        .WithMany()
